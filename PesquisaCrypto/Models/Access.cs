...
namespace PesquisaCrypto.Models
{
    public static class Access
    {
        ...
        public static IDbConnection GetConnection()
        {
            ...
            string connectionString = "Server=127.0.0.1;Database=moedaBD;Uid=root;Pwd=;SSL Mode=none;Certificate Store Location=CurrentUser;";
        ...
        {
            var cmd = new MySqlCommand(command);
        ...
        public static List<T> GetListObjects<T>(string command)
        {
            ...
            MySqlCommand lCmd = new MySqlCommand(command);
        ...
        public static MySqlDataReader ReaderExecute(MySqlCommand command)
        {
            bool retry = false;
            int tentativa = 1;
